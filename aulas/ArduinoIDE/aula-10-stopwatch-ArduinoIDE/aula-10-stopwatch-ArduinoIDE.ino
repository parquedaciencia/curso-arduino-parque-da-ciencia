 ...
 * Caminho no repositório: aulas/ArduinoIDE/aula-10-stopwatch-ArduinoIDE/aula-10-stopwatch-ArduinoIDE.ino
 * Data da última revisão: 16/04/2026
 *
 * Descrição:
 *   ============================================================
 *   Projeto   : Aula 10 - Stopwatch
 *   Arquivo   : aula-10-stopwatch-ArduinoIDE.ino
 *   Pasta     : aula-10-stopwatch-ArduinoIDE
